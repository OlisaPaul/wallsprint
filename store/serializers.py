...
from .utils import create_instance_with_files, save_item, validate_cart, validate_catalog_item_id
...
class AddCartItemSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        return validate_cart(context=self.context, attrs=attrs)

    @transaction.atomic()
    def create(self, validated_data):
        cart_item = save_item(OrderItem, self.context, validated_data)
        return cart_item 

    # def _save_cart_item(self, **kwargs):
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        order_item = save_item(OrderItem, self.context, validated_data)
