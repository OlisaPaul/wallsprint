    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.EmailField(error_messages={'unique': 'A user with that username already exists.'}, max_length=254, null=True, unique=True, verbose_name='email address')),
